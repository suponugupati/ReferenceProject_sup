...
@CucumberOptions(
    ...
    /*tags ={"@signInTest1,"
    		+ "@createNewAccountTest1,"
    		+ "@registerUserPlacesOrderUsingCreditCards1,"
    		+ "@checkoutPlaceOrderUsingSingleGIFTcard1,"
    		+ "@checkoutPlaceOrderUsingBOBsDISCOUNTcard1,"
    		+ "@checkoutPlaceOrderUsingPAYPAL1smoke"}*/
    tags ={"@validateCaseCreationFlow"}
    )
public class CreateACaseFlow  {
